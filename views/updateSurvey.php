    ...
    <div class="container mt-5">
        ...
        <div class="input-group mb-3">
            ...
            <select class="custom-select" id="inputGroupSelect01" name="typeOfManga">
                <option selected value="<?=$viewSurvey->id_typeofmanga ?>"><?=$getOneType->typeofmanga?> selectionné</option>
            ...
            <div class="col-6">
                ...
                <div class="input-group input-group-sm mb-3">
                    <input type="text" class="form-control" placeholder="Premier sujet" name="title1"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?=$viewSurvey->title1?>">
                </div>
            </div>
            <div class="col-6">
                <div class="input-group mb-3">
                ...
                <div class="input-group input-group-sm mb-3">
                    <input type="text" class="form-control" placeholder="deuxieme sujet" name="title2"
                        aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?=$viewSurvey->title2?>">
                </div>
            </div>
            <button type="submit" class="btn btn-outline-secondary mb-3 mt-3 ml-3">Mise a jour</button>
        </div>
    </div>
</form>
<?php
